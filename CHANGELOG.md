...
- Added 8 new skills built on top of Anthropic's marketing plugin: `campaign-plan`, `competitive-brief`, `performance-report` (restructured — brand-kit check added, reference tables split out, house style applied) and `brand-review`, `content-creation`, `newsletter-writer`, `press-release-writer`, `social-content-writer` (already in-style, added as-is). See the Attribution note above the skill tables. 49 skills total.
